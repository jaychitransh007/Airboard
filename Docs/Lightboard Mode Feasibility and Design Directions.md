...
> **Status:** Steps 1–4 plus the P0–P2 overlay pass implemented (2026-07-18) — neon theme, camera/screen underlays, adaptive contrast, crop-correct AR, on-device person occlusion, studio recorder, verified presentation workflow, Meet outbound-RTP proof, and a native click-through desktop shell are live; receiver-side Meet corroboration and steps 5–6 remain external acceptance/proposals. Not part of the public-beta plan.
> **Date:** 2026-07-17
...
3. **[DONE 2026-07-18]** Screenshare presenting mode → use case 1 usable in Meet immediately.
   - **Present is now a workflow:** it automatically enables Lightboard, requires an explicit screen/window, camera, or dark-canvas source, checks the live source + board render + pending-preview state, and requires the presenter to confirm that the meeting's shared-content preview is receiving the Airboard tab. This last step is intentionally explicit because a browser cannot inspect a remote attendee's player.
...
4. **[DONE 2026-07-18, receiver corroboration is an external acceptance step]** Extension camera compositor → Meet camera-tile magic.
   ...
   - AR/occlusion solved (2026-07-18): `object-fit: cover` crop offsets are applied before selfie mirroring and sensitivity for every gesture consumer. The on-device landscape person mask is feathered and reused by the standalone foreground, recorder, and Meet overlay-frame cutout.
