...
- [x] **[REJECTED]** A hidden or visible Airboard `getUserMedia` stream is not reuse of the Meet stream and would require a separate origin-scoped camera grant. Do not present it as a production solution.
